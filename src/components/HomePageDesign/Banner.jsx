...
const Banner = () => {
    return (
        <div>
            <div className="relative bg-gray-900 container mx-auto mt-10">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
                    ...
                    <p className="text-yellow-400 text-xl mb-8">chefSteps offer a vast selection of recipes for all types of cuisines and skill levels. Popular sites include Allrecipes, Food Network, Epicurious, and Bon Appétit, with easy-to-follow instructions and ingredient lists</p>
